...
TARGET_RECOVERY_INITRC := device/samsung/p4-common/rootdir/recovery.rc
...
TW_INTERNAL_STORAGE_PATH := "/data/media" #needs confirmation
TW_INTERNAL_STORAGE_MOUNT_POINT := "data" #needs confirmation
